        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body panelShow">
                    <div class="row">
                        <div class="col-md-12">
                            <form role="form" action="{{ route('admin.image.update', ['id'=>$data->id]) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="parentId" class="form-control">
                                        ...
                                        @foreach($allCategories as $rs)
                                            @if($rs->id != $data->id)
                                                <option value="{{ $rs->id }}">{{ \App\Http\Controllers\Admin\ImageController::getParentsTree($rs, $rs->title) }}</option>
                                            @endif
                                        @endforeach
                                    </select>
                                    <br><br>
